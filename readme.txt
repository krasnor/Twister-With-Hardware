...
Use the sketch in /recognizeLimbs to test if your gloves are detected. You can modify the big if-else statement if have used different resistor values for your gloves.
